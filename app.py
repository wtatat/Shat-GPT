...
FUSION_BRAIN_API_KEY = os.getenv("FUSION_BRAIN_API_KEY", "YOUR_FUSION_BRAIN_KEY")
FUSION_BRAIN_SECRET_KEY = os.getenv("FUSION_BRAIN_SECRET_KEY", "YOUR_FUSION_BRAIN_SECRET")
